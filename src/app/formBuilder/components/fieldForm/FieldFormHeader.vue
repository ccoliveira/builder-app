<script>
  ...
  import FieldFormFontSize from './FieldFormFontSize.vue'
  import FieldFormIcon from './FieldFormIcon.vue'
  ...
  <div>
    <el-tabs>
      ...
      <el-tab-pane :label="$t('othersFields')">
        ...
        <div class="row">
          <FieldFormFontSize :fieldData="fieldData"/>
          <FieldFormIcon :fieldData="fieldData"/>
        </div>
      </el-tab-pane>
