...
export default {
  ...
  methods: {
    ...
    beforeAvatarUpload(file) {
      ...
      if (!isJPG) {
        this.$message.error(this.$t('selectBackground'));
      }
      if (!isLt2M) {
    ...
    handleAvatarSuccess(res, file) {
      ...
      this.$notify({
        ...
        message: (this.instance.type == 'logo' ? 'Logo' : 'Background') + this.$t('logoUpdatedSuccessfully'),
        type: 'success'
      });
  ...
  <modulePanel>
    ...
    <el-row :gutter="10" slot="footer">
      <el-col :span="24">
        ...
        <el-button type="primary" size="small" @click.prevent="submitUpload()" :disabled="!imageUrl" id="buttonSave">
